...
{
    public sealed class LeasedListingCsvMap : ClassMap<LeasedListing>
    {
        public LeasedListingCsvMap()
        {
            Map(m => m.Id).Name("id");
            ...
            Map(m => m.LeasedOn).Name("rent_date");
            Map(m => m.RentPrice).Name("rent_price");
